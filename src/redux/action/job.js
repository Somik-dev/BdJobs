...
import { addJobFail, addJobSuccess, applyFail, applySuccess, btnLoadingStart, deleteFail, deleteSuccess, getAllJObsFail, getAllJObsSuccess, getApplicationsFail, getApplicationsSuccess, getJobofComapnyFail, getJobofComapnySuccess, getSingleJobFail, getSingleJobSuccess, loadingStart, saveJobFail, saveJobSuccess, updateAppFail, updateAppSuccess, updateFail, updateSuccess } from "../reducer/jobReducer";
...
export const updateStatus =
  (id, jobId, value) => async (dispatch) => {
    try {
      ...
      dispatch(updateAppFail(message));
    }
  };
